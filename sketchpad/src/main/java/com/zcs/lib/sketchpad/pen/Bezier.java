package com.zcs.lib.sketchpad.pen;
...
public class Bezier {
    //控制点的，
    private DrawPoint mControl = new DrawPoint();
    //距离
    private DrawPoint mDestination = new DrawPoint();
    //下一个需要控制点
    private DrawPoint mNextControl = new DrawPoint();
    //资源的点
    private DrawPoint mSource = new DrawPoint();
     ...
     */
    public void init(DrawPoint last, DrawPoint cur)
    {
    ...
    public void addNode(DrawPoint cur){
     ...
     * @return
     */
    public DrawPoint getPoint(double t){
